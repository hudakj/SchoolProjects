...
//***************************************************************************
		...
		std::cout << "Enter items to add to the bag (Enter 'stop' to finish adding):";
	...
	cout << "Current bag size: " << bag.getCurrentSize() << endl;
	cout << "Items in the bag: " << bag.toVector() << endl;

	string removeItem;
	
	if (bag.removeAll(removeItem)) {
		cout << "Item removed successfully" << endl;
	}
	else {
		cout << "Item not found in the bag" << endl;
	}
